...
export default function Hero(props: HeroProps) {
    return (
        <div
            className={className([
                chivo.className,
                'sticky left-0 right-0 top-0 z-40 flex min-h-[20rem] flex-col items-center justify-center bg-early-dawn-400 px-4 text-white transition-colors md:px-6 dark:bg-early-dawn-800',
            ])}
        >
            <div>
                <p>Hi, I&apos;m</p>
